...
function Product({ id, category, name, price, image }) {
  ...
  return (
    <div className="max-md:grid max-md:place-items-center">
      <div className="group image bg-light-gray lg:w-[330px] lg:h-[470px] w-[271px] h-[392px] overflow-hidden rounded-[36px] relative lg:hover:w-[400px] lg:hover:h-[511px] hover:w-[300px] hover:h-[420px] hover:shadow-2xl transition-all duration-500">
        <img src={image} alt="product-image" className="object-cover w-full h-full" />
        <div className="absolute bottom-0">
          <img src={productBg} alt="" className="object-cover w-[330px] h-[470px] group-hover:w-[400px] group-hover:h-[511px] bottom-0 transition-none" />
        </div>
        <div className="grid group place-items-center shop-now font-bold w-[105px] h-[36px] border border-white absolute bottom-10 left-14 rounded-xl hover:border-0 hover:bg-[#D9D9D9]">
          <button
            className="text-white text-center text-sm hover:text-black"
      ...
      <div className="txt w-80 mt-6 lg:text-2xl text-xl px-1 flex flex-col gap-2 max-md:ml-10">
        <span className="type">{category?.name}</span>
