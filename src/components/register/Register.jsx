    ...
    <div className="mt-36 lg:mx-52 mx-20 flex lg:gap-10 items-center justify-center">
      <div className="left flex max-md:hidden flex-col items-center justify-center">
        ...
        <div className="flex flex-col justify-center items-center mt-14">
            ...
            <button className="lg:px-[100px] lg:w-[550px] px-14 max-md:w-72 lg:py-4 py-3 rounded-[8px] font-bold bg-dark-blue hover:bg-[#000074] text-white lg:text-2xl text-xl">Create Account</button>
        ...
        <button className="lg:px-[100px] px-4 lg:py-2 rounded-[8px] font-bold border border-black text-[#575757] flex items-center justify-center"><img src={GoogleIcon} alt="" />Sign In with Google</button>
        </div>
        </div>
    </div>
  )
