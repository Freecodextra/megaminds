...
function Deal() {
  return (
    <div className="grid place-items-center">
        <div className="bg-black mt-16 lg:mx-40 mx-6 lg:w-[1067px] lg:h-[556px] lg:rounded-[77px] rounded-[40px] overflow-hidden relative hover:shadow-[0_19px_27px_25px_rgba(0,0,0,0.05)] lg:hover:w-[1123px] lg:hover:h-[586px]">
        <div className="image h-full">
            <img src={dealCard} alt="deal-card-img" className="h-full" />
        </div>
