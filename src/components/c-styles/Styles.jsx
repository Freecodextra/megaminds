...
function Styles() {
  ...
  return (
    <div className="lg:mt-32 mt-20 lg:mx-32">
...
function LatestStyles({title,body,img, isReverse}) {
    ...
    return (
        <div className={`flex items-center justify-center max-md:flex-col lg:mt-16 mt-5 lg:gap-12 ${style} max-md:flex-col-reverse`}>
